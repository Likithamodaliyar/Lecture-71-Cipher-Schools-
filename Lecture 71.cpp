...
int main(){
	string text;
	text = "hi guys how are you doing today, did you get time to watch the new  film and now i want you to find the letter with maximum frequency in this sentence";
